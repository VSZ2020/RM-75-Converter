...
Обоснование разработки утилиты: результаты измерений в PDF-отчете производителя даны в компактном представлении с интервалом 30 мин по столбцам и 3 часа по строкам, что неудобно для дальнейшей обработки оператором и требует дополнительного преобразования таблицы данных в построчный набор значений объемной активности радона, температуры и влажности (при наличии) с интервалом 30 мин.
